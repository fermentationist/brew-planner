...
export interface FormInputOptions {
  ...
  selectRestricted?: boolean; // if true, only allow selectOptions to be selected
  ...
  excludeFromColumns?: boolean; // if true, this input will not be included in columns generated by useCreateColumnsWithUnitConversion.generateColumnsFromInputs()
  ...
  modalStep?: number; // used in ModalForm to determine which step to include this input in
