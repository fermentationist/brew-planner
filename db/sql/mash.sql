CREATE TABLE IF NOT EXISTS mash (
  ...
  mash_id BINARY (16) NOT NULL UNIQUE,
  created_by VARCHAR (36) NOT NULL,
  name VARCHAR (100) NOT NULL,
  UNIQUE KEY (mash_id, name),
...
ALTER TABLE mash ADD INDEX (mash_id);

CREATE TABLE IF NOT EXISTS mash_step (
  mash_step_key INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  mash_step_id BINARY (16) NOT NULL UNIQUE,
  mash_id BINARY (16) NOT NULL,
  CONSTRAINT fk_mash_step_mash_id FOREIGN KEY (mash_id) REFERENCES mash (mash_id),
  name VARCHAR (100) NOT NULL,
  UNIQUE KEY (mash_id, name),
