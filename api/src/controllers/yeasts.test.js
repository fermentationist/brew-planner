...
const validPostDataThunk = async () => {
  return {
    ...
    type: getRandomArrayMembers(yeastService.YEAST_TYPES, 1)[0],
    ...
    flocculation: getRandomArrayMembers(yeastService.FLOCCULATION_TYPES, 1)[0],
...
const invalidPostDataThunk = async (existingYeast) => {
  return {
    ...
    maxReuse: [randomFloat(1, 12, 4), randomString(2)]
  };
}
